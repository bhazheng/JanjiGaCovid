<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <!-- <a class="sidebar-brand brand-logo" href="#"><span class="text-primary">JANJI</span>GACOVID</a>
        <a class="sidebar-brand brand-logo-mini" href="#"><span class="text-primary">JANJI</span>GACOVID</a> -->
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    <div class="count-indicator">
                        <img class="img-xs rounded-circle " src="admin/assets/images/faces/face1.jpg" alt="">
