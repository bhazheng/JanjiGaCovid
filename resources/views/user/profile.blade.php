        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6" style="color: #1C3B48"><label class="labels">Nama Depan</label><input
                                type="text" class="form-control" placeholder="Nama depan" value=""></div>
                        <div class="col-md-6" style="color: #1C3B48"><label class="labels">Nama Belakang</label><input
                                type="text" class="form-control" value="" placeholder="Nama Belakang"></div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-12" style="color: #1C3B48"><label class="labels">No. HP</label><input
                                type="text" class="form-control" placeholder="No. HP" value=""></div>
                        <div class="col-md-12" style="color: #1C3B48"><label class="labels">Alamat</label><input
                                type="text" class="form-control" placeholder="Alamat" value=""></div>
                        <div class="col-md-12" style="color: #1C3B48"><label class="labels">NIK</label><input
                                type="text" class="form-control" placeholder="NIK" value=""></div>
                        <div class="col-md-12" style="color: #1C3B48"><label class="labels">Jenis Kelamin</label><input
                                type="text" class="form-control" placeholder="Laki-laki/Perempuan" value=""></div>
                        <div class="col-md-12" style="color: #1C3B48"><label class="labels">Umur</label><input
                                type="text" class="form-control" placeholder="Umur anda" value=""></div>
                    </div>
                    <!--   <div class="row mt-3">
